...
import { GAME_STEP, useGameLoopContext } from './shared/contexts/GameLoopContext';
...
export default function Home() {
  ...
  return (
    <main className="flex min-h-screen flex-col items-left p-24">
      <h1 className="scroll-m-20 text-4xl font-extrabold tracking-tight lg:text-5xl mb-16">Can you guess future BTC price? <br />Place your bets!</h1>
      <div className="flex mb-16"><span>$</span><BTCPrice /></div>
      {
